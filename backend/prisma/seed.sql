-- ============================================
-- HRIS System Enterprise — Comprehensive Seed Data
-- ============================================
-- Run: mysql -u root -p hris_payroll_db < seed.sql
-- ============================================
...
-- 1. COMPANIES
-- ============================================
INSERT INTO companies (id, code, name, legal_name, tax_id, address, city, province, phone, email, is_active) VALUES
(1, 'PTK', 'PT Karya Teknologi', 'PT Karya Teknologi Indonesia Tbk', '01.234.567.8-901.000', 'Jl. Sudirman No. 88', 'Jakarta', 'DKI Jakarta', '021-12345678', 'corp@karyatkn.co.id', TRUE),
(2, 'MDA', 'Mandiri Abadi', 'PT Mandiri Abadi Sejahtera', '02.345.678.9-012.000', 'Jl. Ahmad Yani No. 45', 'Bandung', 'Jawa Barat', '022-87654321', 'admin@mandiriabadi.co.id', TRUE);

-- ============================================
-- 2. BRANCHES
-- ============================================
INSERT INTO branches (id, company_id, code, name, address, city, phone, email, is_active) VALUES
...
-- 3. DEPARTMENTS
-- ============================================
INSERT INTO departments (id, company_id, parent_id, code, name, description, cost_center, is_active) VALUES
...
-- 4. POSITIONS
-- ============================================
INSERT INTO positions (id, company_id, department_id, code, name, level, min_salary, max_salary, is_active) VALUES
...
-- 5. GRADES
-- ============================================
INSERT INTO grades (id, company_id, code, name, level, min_salary, mid_salary, max_salary, allowance_percentage) VALUES
...
-- ============================================
-- 6. ROLES (already inserted in schema.sql, skip if exists)
-- ============================================
...
-- (2, 'HR Staff', 'HR Staff', 'HR operations', '["view_employees","edit_employees","view_attendance","edit_attendance","view_leave","approve_leave","view_payroll","edit_payroll"]', TRUE),
-- (3, 'Manager', 'Manager', 'Department manager', '["view_employees","view_attendance","approve_attendance","view_leave","approve_leave","view_payroll_own_dept"]', TRUE),
-- (4, 'Employee', 'Employee', 'Employee self-service', '["view_profile","edit_profile","view_attendance_own","apply_leave","view_leave_own","view_payslip"]', TRUE),
-- (5, 'Finance', 'Finance/Payroll', 'Payroll & finance', '["view_employees","view_payroll","edit_payroll","approve_payroll","view_compliance","export_payroll"]', TRUE),
-- (6, 'Director', 'Director', 'Executive access', '["view_all","approve_payroll","approve_high_value"]', TRUE);

-- ============================================
-- 7. USERS (bcrypt hash for 'admin123', 'hr123', etc.)
-- ============================================
-- Password hashes are bcrypt of the plain passwords
INSERT INTO users (id, role_id, username, password_hash, email, phone, is_active) VALUES
(1, 1, 'admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'admin@hris.com', '081234567890', TRUE),
(2, 2, 'hrstaff', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'hr@hris.com', '081234567891', TRUE),
(3, 3, 'manager', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'manager@hris.com', '081234567892', TRUE),
(4, 4, 'employee', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'employee@hris.com', '081234567893', TRUE),
(5, 5, 'finance', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'finance@hris.com', '081234567894', TRUE),
(6, 6, 'director', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'director@hris.com', '081234567895', TRUE);
...
UPDATE users SET employee_id = 8 WHERE id = 2;
UPDATE users SET employee_id = 3 WHERE id = 3;
UPDATE users SET employee_id = 5 WHERE id = 4;
UPDATE users SET employee_id = 9 WHERE id = 5;
UPDATE users SET employee_id = 1 WHERE id = 6;

-- ============================================
-- 9. EMPLOYEE DEPENDENTS
-- ============================================
INSERT INTO employee_dependents (employee_id, name, relationship, date_of_birth, gender, is_covered_bpjs) VALUES
...
-- 10. SHIFTS
-- ============================================
INSERT INTO shifts (id, company_id, code, name, start_time, end_time, break_start, break_end, break_duration_minutes, work_hours, color_code, is_active) VALUES
...
-- 11. HOLIDAYS
-- ============================================
INSERT INTO holidays (id, company_id, name, date, type, is_paid) VALUES
...
-- 12. LEAVE TYPES
-- ============================================
INSERT INTO leave_types (id, company_id, code, name, type, default_days_per_year, max_days_per_request, requires_document, is_paid, accrual_type, color_code, is_active) VALUES
...
-- 13. LEAVE BALANCES
-- ============================================
INSERT INTO leave_balances (employee_id, leave_type_id, year, opening_balance, accrued, taken, adjusted, closing_balance) VALUES
(1, 1, 2026, 12, 0, 3, 0, 9),
(2, 1, 2026, 12, 0, 2, 0, 10),
(3, 1, 2026, 12, 0, 5, 0, 7),
(4, 1, 2026, 12, 0, 1, 0, 11),
(5, 1, 2026, 12, 0, 4, 0, 8),
(6, 1, 2026, 12, 0, 2, 0, 10),
(7, 1, 2026, 12, 0, 0, 0, 12),
(8, 1, 2026, 12, 0, 3, 0, 9),
(9, 1, 2026, 12, 0, 1, 0, 11),
(10, 1, 2026, 12, 0, 2, 0, 10),
(11, 1, 2026, 12, 0, 0, 0, 12),
(12, 1, 2026, 12, 0, 3, 0, 9),
(13, 1, 2026, 12, 0, 4, 0, 8),
(14, 1, 2026, 12, 0, 1, 0, 11),
(15, 1, 2026, 12, 0, 2, 0, 10);

-- ============================================
-- 14. SALARY COMPONENTS
-- ============================================
INSERT INTO salary_components (id, company_id, code, name, type, category, calculation_type, is_taxable, is_pensionable, sequence_order, is_active) VALUES
...
-- 15. ASSET CATEGORIES
-- ============================================
INSERT INTO asset_categories (id, company_id, code, name, depreciation_method, useful_life_years, is_depreciable, is_active) VALUES
...
-- 16. ASSETS
-- ============================================
INSERT INTO assets (id, company_id, asset_category_id, asset_number, name, description, serial_number, purchase_date, purchase_cost, vendor_name, location, condition, assigned_to_employee_id, assigned_date, is_active) VALUES
...
-- ============================================
INSERT INTO training_programs (id, company_id, code, title, description, category, type, duration_hours, cost_estimate, is_active) VALUES
...
-- ============================================
INSERT INTO training_sessions (id, training_program_id, session_code, title, trainer_name, venue, start_datetime, end_datetime, max_participants, enrolled_count, status) VALUES
...
-- 19. PAYROLL PERIODS
-- ============================================
INSERT INTO payroll_periods (id, company_id, code, name, period_type, payment_day, cutoff_day, fiscal_year, period_number, start_date, end_date, payment_date, status) VALUES
...
-- ============================================
-- 20. PAYROLL TRANSACTIONS (sample for June 2026)
-- ============================================
INSERT INTO payroll_transactions (payroll_period_id, employee_id, employee_number, employee_name, department_id, position_id, working_days, present_days, basic_salary, gross_salary, earnings, deductions, bpjs_health_employee, bpjs_employment_employee, net_salary, payment_status) VALUES
...
-- 21. BPJS CONFIG
-- ============================================
INSERT INTO bpjs_health_config (id, company_id, year, employee_percentage, employer_percentage, min_base_salary, max_base_salary, is_active, effective_from) VALUES
(1, 1, 2026, 1.00, 4.00, 1000000, 12000000, TRUE, '2026-01-01');

INSERT INTO bpjs_employment_config (id, company_id, year, jht_employee_percentage, jht_employer_percentage, jp_employee_percentage, jp_employer_percentage, jkk_percentage, jkm_percentage, min_base_salary, max_base_salary, is_active, effective_from) VALUES
(1, 1, 2026, 2.00, 3.70, 1.00, 2.00, 0.24, 0.30, 1000000, 14000000, TRUE, '2026-01-01');

-- ============================================
-- 22. TAX RATES (PPh21)
-- ============================================
INSERT INTO tax_rates (id, year, layer_number, min_income, max_income, tax_rate, is_active) VALUES
...
-- 23. NOTIFICATIONS
-- ============================================
INSERT INTO notifications (user_id, notification_type, title, message, channel, priority, status, created_at) VALUES
...
-- ============================================
-- 24. ATTENDANCE RECORDS (sample)
-- ============================================
INSERT INTO attendance_records (employee_id, date, check_in_time, check_out_time, check_in_method, work_hours, status, created_at) VALUES
...
-- ============================================
-- 25. LEAVE REQUESTS (sample)
-- ============================================
INSERT INTO leave_requests (employee_id, leave_type_id, start_date, end_date, total_days, working_days, reason, status, submitted_at) VALUES
...
-- 26. SCHEDULES (sample)
-- ============================================
INSERT INTO schedules (employee_id, shift_id, date, is_off) VALUES
(1, 1, '2026-07-16', FALSE),
(3, 1, '2026-07-16', FALSE),
(4, 1, '2026-07-16', FALSE),
(5, 1, '2026-07-16', FALSE),
(6, 1, '2026-07-16', FALSE),
(7, 1, '2026-07-16', FALSE),
(8, 1, '2026-07-16', FALSE),
(9, 1, '2026-07-16', FALSE),
(10, 1, '2026-07-16', FALSE),
(11, 1, '2026-07-16', FALSE),
(12, 1, '2026-07-16', FALSE),
(13, 1, '2026-07-16', FALSE),
(14, 1, '2026-07-16', FALSE),
(15, 1, '2026-07-16', FALSE),
(16, 1, '2026-07-16', FALSE),
(17, 1, '2026-07-16', FALSE),
(18, 1, '2026-07-16', FALSE),
(19, 1, '2026-07-16', FALSE),
(20, 2, '2026-07-16', FALSE);

-- ============================================
-- 27. TRAINING ENROLLMENTS
-- ============================================
INSERT INTO training_enrollments (training_session_id, employee_id, enrollment_status) VALUES
(1, 3, 'Registered'),
(1, 4, 'Registered'),
(1, 5, 'Registered'),
(1, 8, 'Registered'),
...
-- ============================================
-- 28. EMPLOYEE SALARY HISTORY
-- ============================================
INSERT INTO employee_salary_history (employee_id, effective_date, basic_salary, grade_id, position_id, reason, approved_by) VALUES
